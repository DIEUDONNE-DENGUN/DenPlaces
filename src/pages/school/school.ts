...
export class SchoolPage {
  ...
  ionViewDidEnter() {
    ...
    this.location_handler.showLoader("Loading nearby schools....");
  ...
  */
  ...
  initMap() {
    ...
    this.geolocation.getCurrentPosition().then((position) => {
      ...
      let types = ['school'];
      this.getNearbyActivities(types, this.current_location, current);
    });
 ...
 */
  getNearbyActivities(place_type: any, user_current_location: any, current_location): void {
